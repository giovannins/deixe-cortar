...
<template>
  <div id="modal" class="modal">
    ...
    <div class="modal-content">
      <div class="box">
        <p class="block">
          Are you sure you want to delete this Employee ({{ employeeStore.employee.name }})?
        </p>
        <div class="buttons my-2">
          <button class="button is-danger" @click="deleteEmployee(employeeStore.employee.id)">Yes</button>
  ...
  <section class="container is-fluid mt-6">
    <div class="card">
      ...
      <footer class="card-footer buttons has-addons">
        <router-link
          :to="{ name: 'barbershop-detail', params: { id: employeeStore.employee.barbershopId } }"
